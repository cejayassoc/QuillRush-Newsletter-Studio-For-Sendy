    ...
    function renderFooter(settings, format) {
        ...
        <div style="background-color: #0f172a; padding: 32px 20px 40px; text-align: center; color: #cbd5e1; border-top: 1px solid #1e293b;">
            ...
            <div style="margin-bottom: 20px;">
                ${settings.social_instagram ? `<a href="${settings.social_instagram}" style="display:inline-block; width:30px; height:30px; line-height:30px; border-radius:50%; background:#334155; color:#ffffff; text-align:center; text-decoration:none; font-family:Arial, sans-serif; font-size:13px; font-weight:bold; margin:0 4px;">IG</a>` : ''}
                ${settings.social_linkedin ? `<a href="${settings.social_linkedin}" style="display:inline-block; width:30px; height:30px; line-height:30px; border-radius:50%; background:#334155; color:#ffffff; text-align:center; text-decoration:none; font-family:Arial, sans-serif; font-size:13px; font-weight:bold; margin:0 4px;">in</a>` : ''}
                ${settings.social_twitter ? `<a href="${settings.social_twitter}" style="display:inline-block; width:30px; height:30px; line-height:30px; border-radius:50%; background:#334155; color:#ffffff; text-align:center; text-decoration:none; font-family:Arial, sans-serif; font-size:14px; font-weight:bold; margin:0 4px;">X</a>` : ''}
                ${settings.social_youtube ? `<a href="${settings.social_youtube}" style="display:inline-block; width:30px; height:30px; line-height:30px; border-radius:50%; background:#334155; color:#ffffff; text-align:center; text-decoration:none; font-family:Arial, sans-serif; font-size:11px; font-weight:bold; margin:0 4px;">YT</a>` : ''}
            </div>
            <div>
